  ...
  return (
    <section>
      ...
      <div className="w-[60vw] mx-auto my-20">
        <h1 className="text-center font-bold text-2xl border border-black rounded-t-md bg-black text-white p-1">
          Login
        </h1>
        <form
        ...
        >
          ...
          />
          <button
            className="col-span-2 bg-black text-white hover:bg-sec w-14 m-auto p-1 my-2 rounded-md"
            disabled={isLoading}
          >
            Login
          </button>
          ...
          <FcGoogle className="inline text-[20px] mx-2" /><Link>Signin With Google</Link><br/>
            New user?{" "}
            <Link
              to={"/profile/signup"}

...
const Todo = () => {
  ...
  return (
    <div id="todo" className="h-screen w-screen bg-bgc overflow-auto">
      <div
        id="todo-header"
        className="bg-black h-[8vh] font-bold text-white p-2 text-xl sticky top-0"
      >
        Task
      </div>
      <section>
        ...
        >
          ...
          <button
            onClick={add}
            id="todo-add-btn"
            className="bg-black grid place-items-center p-2 rounded-md hover:bg-pri text-white"
          >
            Create Task
          </button>
        </div>
